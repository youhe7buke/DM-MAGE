...
# 创建保存模型的目录
os.makedirs('model/model_save_pretrain', exist_ok=True)
os.makedirs('model/model_save_ae', exist_ok=True)
os.makedirs('model/model_save_gae', exist_ok=True)
...
# 可视化结果
visualize_tsne(args.pre_model_save_path, args.name)
